...
echo "         \"description\": \"Ensures APP_DEBUG is false in production environment\",\n";
echo "         \"status\": \"failed\",\n";
echo "         \"message\": \"APP_DEBUG is enabled in production environment\",\n";
echo "         \"severity\": \"critical\",\n";
echo "         \"details\": {\n";
echo "           \"current_env\": \"production\",\n";
echo "           \"debug_value\": true,\n";
echo "           \"recommendation\": \"Set APP_DEBUG=false in your .env file for production\"\n";
echo "         }\n";
echo "       }\n";
echo "     ]\n";
echo "   }\n";
